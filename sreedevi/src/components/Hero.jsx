import profilePic from '../assets/sreedeviProfile.png'
    ...
    <div className="pb-4 lg:mb-36">
        <div className="flex flex-wrap lg:flex-row-reverse">
            ...
            <div className="flex flex-col items-center lg:items-start mt-10">
                <h2 className='pb-2 text-4xt tracking-tighter lg:text-8xl'>V S Sreedevi</h2>
                ...
                <a href="/V S Sreedevi - Full Stack Developer.pdf"
                target='_blank'
